...
def get_info():
    ...
    try:
        ...
        error = tk.Label(windo, text="Something went wrong!! Please check URL", width=40, height=5, fg="white", bg="red",
                        font=('times', 18, ' bold '))
    ...
    im7 = PIL.Image.open('thumbnail.png')
...
def download_button(event):
    im7 = PIL.Image.open('download.png')
...
pred = tk.Label(windo, text="YouTube Downloader", width=30, height=2, fg="white", bg="maroon2",
                font=('times', 25, ' bold '))
